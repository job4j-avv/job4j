...
public class BoardTest {
    ...
    public void when4x4() {
        ...
        String ln = System.lineSeparator();
        assertThat(rsl, is(String.format("X X %s X X%sX X %s X X%s", ln, ln, ln, ln))
        );
    }
    ...
    public void when8x8() {
        ...
        String ln = System.lineSeparator();
        assertThat(rsl, is(String.format("X X X X %s X X X X%sX X X X %s X X X X%sX X X X %s X X X X%sX X X X %s X X X X%s", ln, ln, ln, ln, ln, ln, ln, ln))
        );
    }
}